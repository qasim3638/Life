...
- 2026-02: **Chat persistence indicator** — Companion header now shows "· N msgs kept" next to persona label with a tooltip explaining history is saved and Najm uses recent messages + memories to recall topics.
