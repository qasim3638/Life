...
export const QuotationPrintPreview = ({
  printRef,
  quotationData,
  totals,
  calculateLineTotal
  ...
  return (
    <div ref={printRef} className="bg-white p-8 border rounded-lg" style={{ maxWidth: '850px', margin: '0 auto' }}>
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div>
          <h1 className="text-4xl font-bold" style={{ fontFamily: 'Georgia, serif' }}>Quotation</h1>
        ...
        <div className="w-64">
          ...
          <table className="w-full border-collapse" style={{ fontSize: '11px' }}>
            <tbody>
              ...
              <tr>
                <td className="border border-gray-400 px-2 py-1" colSpan={2}>Subtotal (excl. VAT)</td>
                <td className="border border-gray-400 px-2 py-1 text-right">£ {(totals.grossTotal / 1.2).toFixed(2)}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="border border-gray-400 px-2 py-1 font-bold" colSpan={2}>Total (incl. VAT)</td>
      ...
      <div style={{ borderTop: '1px solid #333', paddingTop: '10px' }}>
        <p className="font-bold text-xs mb-1">Quotation Notes:</p>
        <p style={{ fontSize: '10px', lineHeight: '1.4', color: '#333' }}>
          {quotationData.notes || 'This quotation is subject to stock availability. Prices may vary based on current market conditions. To proceed with your order, please contact us or visit one of our showrooms.'}
        </p>
        <p style={{ fontSize: '10px', lineHeight: '1.4', color: '#666', marginTop: '8px' }}>
          • Prices include VAT at 20% • Delivery charges may apply • Stock subject to availability
        </p>
      </div>
    </div>
  );
